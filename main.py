...
def create_rooms(num_rooms):
    room_names = [
        "Cozy Cottage", "Luxury Villa", "Modern Apartment", "Downtown Studio", "Suburban House",
        "Beachfront Bungalow", "Mountain Cabin", "Country House", "Urban Loft", "Penthouse Suite",
        "Garden Flat", "Lake House", "Historic Manor", "Ski Chalet", "Desert Oasis",
        "City Condo", "Rural Retreat", "Forest Lodge", "Seaside Cottage", "Countryside B&B",
        "Island Villa", "Eco-friendly Home", "High-rise Apartment", "Vintage Caravan", "Castle",
        "Riverside Cabin", "Luxury Tent", "Houseboat", "Studio Apartment", "Bamboo Hut",
        "Geodesic Dome", "Cave House", "Treehouse", "Victorian Home", "Retro Camper",
        "Modern Loft", "Barn Conversion", "Chateau", "Tiny House", "Hunting Lodge",
        "Country Estate", "Urban Penthouse", "Hillside Villa", "Fishing Cabin", "Rustic Barn",
        "Safari Tent", "Artistic Studio", "Clifftop House", "Subterranean Home", "City Flat"
    ]
    ...
    for i in range(num_rooms):
        ...
        print(f"Created room: {name}, Price: ${price_per_night}, Capacity: {capacity}")
